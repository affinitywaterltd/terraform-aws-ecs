...
resource "aws_appautoscaling_target" "ecs_target" {
  ...
  resource_id        = var.terraform_match_task_definition_service ? "service/${aws_ecs_cluster.this[0].name}/${aws_ecs_service.this_match[count.index].name}" : "service/${aws_ecs_cluster.this[0].name}/${aws_ecs_service.this[count.index].name}"
...
resource "aws_appautoscaling_policy" "ecs_policy_cpu" {
  ...
  name               = var.terraform_match_task_definition_service ? "auto-scaling-tracking-${aws_ecs_service.this_match[count.index].name}-cpu" : "auto-scaling-tracking-${aws_ecs_service.this[count.index].name}-cpu"
...
resource "aws_appautoscaling_policy" "ecs_policy_memory" {
  ...
  name               = var.terraform_match_task_definition_service ? "ecs-auto-scaling-tracking-${aws_ecs_service.this_match[count.index].name}-memory" : "ecs-auto-scaling-tracking-${aws_ecs_service.this[count.index].name}-memory"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.ecs_target[count.index].resource_id
  scalable_dimension = aws_appautoscaling_target.ecs_target[count.index].scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs_target[count.index].service_namespace
...
resource "aws_appautoscaling_scheduled_action" "ecs_policy_scheduled_0" {
  ...
  name               = var.terraform_match_task_definition_service ? "ecs-auto-scaling-scheduled-${aws_ecs_service.this_match[count.index].name}-0" :  "ecs-auto-scaling-scheduled-${aws_ecs_service.this[count.index].name}-0"
  resource_id        = aws_appautoscaling_target.ecs_target[count.index].resource_id
  scalable_dimension = aws_appautoscaling_target.ecs_target[count.index].scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs_target[count.index].service_namespace
...
resource "aws_appautoscaling_scheduled_action" "ecs_policy_scheduled_1" {
  ...
  name               = var.terraform_match_task_definition_service ? "ecs-auto-scaling-scheduled-${aws_ecs_service.this_match[count.index].name}-1" : "ecs-auto-scaling-scheduled-${aws_ecs_service.this[count.index].name}-1"
  resource_id        = aws_appautoscaling_target.ecs_target[count.index].resource_id
  scalable_dimension = aws_appautoscaling_target.ecs_target[count.index].scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs_target[count.index].service_namespace
...
resource "aws_appautoscaling_scheduled_action" "ecs_policy_scheduled_2" {
  ...
  name               = var.terraform_match_task_definition_service ? "ecs-auto-scaling-scheduled-${aws_ecs_service.this_match[count.index].name}-2" : "ecs-auto-scaling-scheduled-${aws_ecs_service.this[count.index].name}-2"
  resource_id        = aws_appautoscaling_target.ecs_target[count.index].resource_id
  scalable_dimension = aws_appautoscaling_target.ecs_target[count.index].scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs_target[count.index].service_namespace
...
resource "aws_appautoscaling_scheduled_action" "ecs_policy_scheduled_3" {
  ...
  name               = var.terraform_match_task_definition_service ? "ecs-auto-scaling-scheduled-${aws_ecs_service.this_match[count.index].name}-3" : "ecs-auto-scaling-scheduled-${aws_ecs_service.this[count.index].name}-3"
  resource_id        = aws_appautoscaling_target.ecs_target[count.index].resource_id
  scalable_dimension = aws_appautoscaling_target.ecs_target[count.index].scalable_dimension
  service_namespace  = aws_appautoscaling_target.ecs_target[count.index].service_namespace
